...
player_rect = pygame.Rect(WIDTH // 2, HEIGT // 2, *player.get_size()) # player.get_rect()
...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH-200, random.randint(25, HEIGT-25), *enemy.get_size())
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(100, WIDTH-100), 20, *bonus.get_size())
